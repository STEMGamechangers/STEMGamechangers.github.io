# STEM Gamechangers Hackathon

This GitHub repository is the source code for the Gamechangers in STEM website: STEMGamechangers.github.io.

It was built based on the [Event Jekyll Theme](https://github.com/melvinchng/event-jekyll-theme) which was created by [Melvin Ch'ng](https://github.com/melvinchng). It is used under the [GPL 3.0 license](LICENSE). THANK YOU Melvin for providing such an awesome resource :sparkles::tada:

---

# ORIGINAL README: Event Jekyll Theme
...
### More features
- Google Analytics built in (replace `UA-xxxxxxxx-x` with your personal analytics verification key in `_includes/core_data/head.html`)
